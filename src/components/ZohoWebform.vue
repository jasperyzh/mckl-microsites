<template>
    <form action="https://crm.zoho.com/crm/WebToLeadForm" name="WebToLeads4875945000004073003" method="POST"
        ...
        <div class="row g-2">
            ...
            <!-- campus:LEADCF23 -->
            <div class="col-12">
                <label class="d-block">Campus: <span class="text-danger">*</span></label>
                <div class="btn-group w-100" role="group" aria-label="Radio toggle button group for Campus selection">
                    <input type="radio" class="btn-check" name="campus" id="campus_kl" value="KL Campus"
                        v-model="form_data.campus" @change="clear_programme_interested()" autocomplete="off" checked>
                    ...
                    <label class="btn btn-outline-primary btn-sm" for="campus_penang">Pykett, Penang Campus</label>
                </div>
            </div>
        ...
        <div class="row" v-if="microsite_source === 'scholarship'">
            ...
            <div class="col-12">
                ...
                <select class="form-select" id="latest_academic_qualification" name="LEADCF5" required
...
onMounted(() => {
    THE_FORM.value.addEventListener('formdata', (e) => {
        ...
        formData.set('xmIwtLD', "3df8513a44e8ee0dc6e36209ffd3db2439ef2cc150b37c8431e58c9fcba68bbe");
