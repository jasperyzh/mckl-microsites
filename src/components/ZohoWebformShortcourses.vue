...
<<<<<<< HEAD
  <form
    ...
    name="WebToLeads4875945000000954001"
    method="POST"
...
<<<<<<< HEAD
      <div class="col-12">
        <label for="programme_interested"
          >Interested Course <span class="text-danger">*</span></label
        >
        <select
          class="form-select"
        ...
        >
          ...
          >
            <option
              ...
              :key="option_index"
              :value="option_index"
              :selected="option_index === form_data.programme_interested"
              v-html="option_name"
            ></option>
          </optgroup>
        </select>
...
onMounted(() => {
  ...
  THE_FORM.value.addEventListener("formdata", (e) => {
    ...
    formData.set(
      "xmIwtLD",
      "3df8513a44e8ee0dc6e36209ffd3db240675dcf6887b53b2398a3abd933e9f68"
    );
    ...
    if (
      ...
      // LEADCF22 || LEADCF11
      for (const key in props.programme_interested.LEADCF22.options) {
      ...
      for (const key in props.programme_interested.LEADCF11.options) {
        if (key === form_data.programme_interested) {
          ...
          formData.set(
            form_data.programme_interested_LEADCFID,
            check_courses(form_data.programme_interested)
          );
          return;
        }
      }
    ...
    default(rawProps) {
      return {
        ...
        LEADCF11: {
          title: "Free Courses",
          options: {
            "Website Design with Google Sites":
              "Website Design with Google Sites",
            "Embracing Autism": "Embracing Autism",
            "Information Literacy and Online Search Strategies":
              "Information Literacy and Online Search Strategies",
            "Introduction to Psychology for Social Workers":
              "Introduction to Psychology for Social Workers",
            "Learning Skills for Lifelong Learning":
              "Learning Skills for Lifelong Learning",
            "Successful Entry to Top Universities in the World":
              "Successful Entry to Top Universities in the World",
          },
        },
      };
